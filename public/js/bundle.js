...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/prosenjitbarman/cl4w81q2a003214q8mrmx1vlp',
    // style URL
  ...
  var bounds = new mapboxgl.LngLatBounds(); //areas that will be displayed on the map.
...
var stripe = Stripe('pk_test_51LKxi5CslBonPL9AizoK4rS0LnChhjnMsFVShbI4YxeF10A0P3OoZ1p7TjX4gEompobN8ADJceyQLdcx6fCjgxFa00nGq1cmer');
...
if (signupForm) {
  ...
  signupForm.addEventListener('submit', function (e) {
    ...
    var name = document.getElementById('name').value; //Value capturing from a field

    var email = document.getElementById('email').value; //Value capturing from a field

    var password = document.getElementById('password').value; //Value capturing from a field

    var passwordConfirm = document.getElementById('passwordConfirm').value; //Value capturing from a field
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  form.append('photo', document.getElementById('photo').files[0]); // const name = document.getElementById('name').value; //Value capturing from a field
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordCurrent = document.getElementById('password-current').value; //Value capturing from a field

            password = document.getElementById('password').value; //Value capturing from a field

            passwordConfirm = document.getElementById('password-confirm').value; //Value capturing from a field
